...
func (f fakeStatusSvc) SendText(context.Context, string, string, string) (store.Message, error) { return store.Message{}, nil }
...
func (f fakeStatusSvc) ListReceipts(context.Context, string) ([]store.Receipt, error) { return nil, nil }
