...
func (f *fakeSendSvc) EditMessage(context.Context, string, string) (store.Message, error) {
	return store.Message{}, nil
}
func (f *fakeSendSvc) DeleteMessage(context.Context, string) error { return nil }
